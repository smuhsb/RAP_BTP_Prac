CLASS zcl_generate_travel_data_897 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_897 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_897.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_897.

*   insert the new table entries
    INSERT ztravel_897 FROM TABLE @itab.
